...
class OBDPort:
     ...
     def __init__(self,portnum,_notify_window,SERTIMEOUT,RECONNATTEMPTS):
         ...
         debug_display(self._notify_window, 2, "Status:" + self.get_result()) #add by me, becoz after connected, elm327 return "connected"
         ...
         #atib96 \n atiia13 \n atsh8113f1 \n atspa4 \n atsw00
         debug_display(self._notify_window, 2, "setting protocol to TOYOTA K-LINE")
         self.send_command("atib96")
         debug_display(self._notify_window, 2, "atib96 response:" + self.get_result())
         self.send_command("atiia13")
         debug_display(self._notify_window, 2, "atiia13 response:" + self.get_result())
         self.send_command("atsh8113f1")
         debug_display(self._notify_window, 2, "atsh8113f1 response:" + self.get_result())
         self.send_command("atspa4")
         debug_display(self._notify_window, 2, "atspa4 response:" + self.get_result())
         self.send_command("atsw00")
         debug_display(self._notify_window, 2, "atsw00 response:" + self.get_result())
         debug_display(self._notify_window, 2, "Protocol set to TOYOTA K-LINE for SIENTA")
